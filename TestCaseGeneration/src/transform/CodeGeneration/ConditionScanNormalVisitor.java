...
public class ConditionScanNormalVisitor extends DoNothingVisitor 
{
	boolean hasreal;
    ...
    public ConditionScanNormalVisitor(ArrayList<Parameter> listPara, ArrayList<Variable> listVar, ArrayList<Condition> listCon)
    {
    	hasreal = false;
